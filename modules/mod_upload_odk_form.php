...
<form id="odk_upload_form" class="form-horizontal odk_uploader" method="POST" enctype="multipart/form-data" action="index.php?page=odk_uploader&do=do_upload&action=upload" onsubmit="return window.uploader.validateInput();">
   <div id="odk_instructions"><p>This tool uploads ODK forms into the ODK Aggregate server maintained by the Azizi Biorepository team. Click <a href="http://opendatakit.org/help/form-design/xlsform/" target="_blank">here</a> if you need assistance in defining ODK forms as Excel files. An email with further instructiosn will be sent to your email address after your ODK form has been successfully uploaded onto the ODK Server</p></div>
...
<?php
   ...
   private function sendInstructionEmail($formName, $instanceID,  $address) {
      ...
      $message = "Hi ".$_SESSION['onames'].",\n".$formName." (with insance_id as ".$instanceID.") has been successfully uploaded onto the Azizi ODK Server.".
              ...
              "You can access these settings from ODC Collect's 'General Settings' option. Reply to this email for further assistance";
